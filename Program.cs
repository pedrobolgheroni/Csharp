...
{
    if(modelAction == "List") // apresenta todos os registros do bdd
    {
    ...
    if(modelAction == "New") // adiciona no bdd
    {
    ...
    if(modelAction == "Show") // apresenta uma determinada linha do bdd
    {
    ...
    if(modelAction == "Update") // atualiza uma linha do bdd
    {
    ...
    if(modelAction == "Delete") // exclui uma linha do bdd
    {
