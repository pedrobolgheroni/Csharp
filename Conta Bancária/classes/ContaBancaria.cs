...
public class ContaBancaria
{
    ...
    public string ObterHistoricodeConta()
    {
        ...
        decimal saldo = 0m;
        relatorio.AppendLine("Data\t\tQuantia\tSaldo\tNota"); // AppendLine() - Adiciona ao final da linha \t - tabulação
    ...
    public virtual void ExecutarTransacoesdeFimdeMes() { } // Um método virtual é um método em que qualquer classe derivada pode optar por reimplementar
